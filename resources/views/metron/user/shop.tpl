                    ...
                    <div class="d-flex flex-column-fluid">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                {if $metron['shop_activity_true'] === true &&
                                strtotime({$metron['shop_activity_buy_time']}) > time()}
                                        ...
                                        <div class="card-body d-flex flex-column p-0" style="position: relative;">
                                            <div class="" style="height: 100px; min-height: 100px;">
                                                <h3 class="display-3 text-white text-center">
                                                    <strong>{$metron['shop_activity_name']}</strong>
                                                </h3>
                                            </div>
                                            <div
                                                ...
                                                <ul class="dashboard-tabs nav nav-pills row nav-primary row-paddingless m-0 p-0"
                                                    role="tablist">
                                                    <li
                                                        class="nav-item d-flex col flex-grow-1 flex-shrink-0 ml-1 mr-1 mb-0 cursor_onclick">
                                                ...
                                                <div class="tab-content m-0 p-0">
                                                    <div class="tab-pane active show" id="shop-activity"
                                                        ...
                                                        <div class="row">
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                <div class="display-3 text-primary font-weight-bolder">
                                                                    ...
                                                                    <strong>{$shop_activity->price}</strong>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex flex-column w-100 pl-2 pt-3">
                                                            <span class="font-size-sm text-muted font-weight-bold pb-3">
                                                                {if $shopLt == 0}此商品无限制购买{else}<span
                                                                    class="{if $shopBi < 5}text-danger{else}text-primary{/if}">{if
                                                                    $shopCan === 0}此商品已售空, 可尝试购买其它时长{else}此商品限购剩余
                                                                    {$shopCan} 份{/if}{/if}</span>
                                                            </span>
                                                            <div class="progress progress-md w-100">
                                                                <div class="progress-bar progress-bar-striped {if $shopBi < 5}bg-danger{else}bg-primary{/if}"
                                                                    role="progressbar" style="width: {$shopBi}%;"
                                                        ...
                                                        <div
                                                            class="row text-center {$style[$theme_style]['shop']['card_text']}">
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                <div class="font-size-sm text-muted font-weight-bold">
                                                                    会员等级
                                                                </div>
                                                                <div class="font-size-h4 font-weight-bolder">
                                                                    {$metron['user_level'][$shop_activity->user_class()]}
                                                                </div>
                                                            </div>
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                <div class="font-size-sm text-muted font-weight-bold">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                ...
                                                                <div class="font-size-h4 font-weight-bolder">{if
                                                                    $shop_activity->reset()!=0}{$shop_activity->reset()}天重置{else}到期清零{/if}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                ...
                                                                <div class="font-size-h4 font-weight-bolder">{if
                                                                    {$shop_activity->connector()} == '0'
                                                                    }无限制{else}{$shop_activity->connector()}个设备{/if}
                                                                </div>
                                                            </div>
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                <div class="font-size-sm text-muted font-weight-bold">
                                                                ...
                                                                <div class="font-size-h4 font-weight-bolder">{if
                                                                    {$shop_activity->speedlimit()} == '0'
                                                                    }无限制{else}{$shop_activity->speedlimit()}Mbps{/if}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <!-- <div class="row text-center">
                                                            <div class="col pl-6 pt-4 pb-0">
                                                                <div
                                                                    class="font-size-h4 font-weight-bolder {$style[$theme_style]['shop']['card_text']}">
                                                                    {$metron['shop_activity_text']}</div>
                                                            </div>
                                                        </div> -->
                                                        {/if}
                                                        ...
                                                        <!-- <div class="row text-center">
                                                            <div class="col pl-6 pt-4 pb-0">
                                                                ...
                                                                {else}
                                                                <div
                                                                    class="font-size-h4 font-weight-bolder text-dark-50">
                                                                    <del>{$service[1]}</del>
                                                                </div>
                                                                {/if}
                                                            </div>
                                                        ...
                                                        {/foreach}
                                                        <div class="pt-8">
                                                            {if $shopLt != 0 && $shopCan <= 0} <button
                                                                class="btn {$style[$theme_style]['shop']['card_btn']} btn-block btn-pill"
                                                                href="javascript:void(0);" type="button"
                                                                onClick="shop.metronBuy('{$shop_activity->id}',{$shop_activity->auto_renew});"
                                                                id="buytext-{$shop_activity->id}" disabled="true">
                                                                此商品已达到购买上限
                                                                </button>
                                                                {else}
                                                                <button
                                ...
                                {if $metron['shop_Experience_true'] === true && $user->class === -1 &&
                                $user->lastSsTime() == '从未使用喵' && $metron['shop_Experience_pos'] === 'top'}
                                        ...
                                        <div class="card-body d-flex flex-column p-0" style="position: relative;">
                                            ...
                                            <div
                                                ...
                                                <ul class="dashboard-tabs nav nav-pills row nav-primary row-paddingless m-0 p-0"
                                                    ...
                                                    <li
                                                        class="nav-item d-flex col flex-grow-1 flex-shrink-0 ml-1 mr-1 mb-0 cursor_onclick">
                                                        <a class="nav-link border d-flex flex-grow-1 rounded flex-column align-items-center p-1 {if $shop@index === 0} active{/if}"
                                                            data-toggle="pill" href="#tab-shop-{$shop->id}">
                                                            <span
                                                                class="nav-text font-size-lg py-2 font-weight-bold text-center">{$key}</span>
                                                        </a>
                                                    </li>
                                                    {/foreach}
                                                </ul>
                                                <div class="tab-content m-0 p-0">
                                                    {foreach $shop_cate as $key => $shop}
                                                    <div class="tab-pane {if $shop@index === 0} active {/if}"
                                                        id="tab-shop-{$shop->id}" role="tabpanel">
                                                        <div class="row">
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                <div class="display-3 text-primary font-weight-bolder">
                                                                    <small><i
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                <div class="font-size-sm text-muted font-weight-bold">
                                                                    会员等级</div>
                                                                <div class="font-size-h4 font-weight-bolder">
                                                                    {$metron['user_level'][$shop->user_class()]}</div>
                                                            </div>
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                <div class="font-size-sm text-muted font-weight-bold">
                                                                    等级时长</div>
                                                                <div class="font-size-h4 font-weight-bolder">
                                                                    {$shop->class_expire()} 天</div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            class="row text-center {$style[$theme_style]['shop']['card_text']}">
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                <div class="font-size-sm text-muted font-weight-bold">
                                                                    添加流量</div>
                                                                <div class="font-size-h4 font-weight-bolder">
                                                                    {$shop->bandwidth()} GB</div>
                                                            </div>
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                <div class="font-size-sm text-muted font-weight-bold">
                                                                    重置周期</div>
                                                                <div class="font-size-h4 font-weight-bolder">{if
                                                                    $shop->reset()!=0}{$shop->reset()}天重置{else}到期清零{/if}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                ...
                                                                <div class="font-size-h4 font-weight-bolder">{if
                                                                    {$shop->connector()} == '0'
                                                                    }无限制{else}{$shop->connector()}个设备{/if}</div>
                                                            </div>
                                                            <div class="col pl-6 pt-6 pb-0">
                                                                <div class="font-size-sm text-muted font-weight-bold">
                                                                    峰值速率</div>
                                                                <div class="font-size-h4 font-weight-bolder">{if
                                                                    {$shop->speedlimit()} == '0'
                                                                    }无限制{else}{$shop->speedlimit()}Mbps{/if}</div>
                                                            </div>
                                                        </div>
                                                        {if $key !== ''}
                                                        <!-- <div class="row text-center">
                                                        ...
                                                        <div class="pt-8">
                                                            {if $shopLt != 0 && $shopCan <= 0} <button
                                                                ...
                                                                id="buytext-{$shop->id}" disabled="true">
                                                                此商品已达到购买上限</button>
                                                                {else}
                                                                <button
                                                                    class="btn {$style[$theme_style]['shop']['card_btn']} btn-block btn-pill"
                                ...
                                {if $metron['shop_Experience_true'] === true && $user->class === -1 &&
                                $user->lastSsTime() == '从未使用喵' && $metron['shop_Experience_pos'] === 'bottom'}
                                {include file='include/shop/Trial.tpl'}
                                {/if}
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-body">
                    ...
                    <label class="row col-12 col-form-label kt-font-boldest" id="shop_credit"
                    ...
                    <div class="form-group row form-group-marginless" style="display: none" id="shop_payment">
                        ...
                        <div class="col-lg-12">
                            <ul class="dashboard-tabs nav nav-pills row row-paddingless m-0 p-0" role="tablist"
                                ...
                                <li
                                    class="nav-alipay nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0 cursor_onclick">
                                ...
                                <li
                                    class="nav-wxpay nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0 cursor_onclick">
                                    <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center"
                                        ...
                                        <span
                                            class="nav-text font-size-lg py-2 font-weight-bold text-center">微信支付</span>
                                    </a>
                                </li>
                                {/if}
                                ...
                                <li
                                    class="nav-qqpay nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0 cursor_onclick">
                                    <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center {if ($metron['pay_alipay'] == 'none' || $metron['pay_alipay'] == '') && ($metron['pay_wxpay'] == 'none' || $metron['pay_wxpay'] == '')}active{/if}"
                                        ...
                                        <span
                                            class="nav-text font-size-lg py-2 font-weight-bold text-center">QQ钱包</span>
                                    </a>
                                </li>
                                {/if}
                                {if $metron['pay_crypto'] != 'none' && $metron['pay_crypto'] != ''}
                                <li
                                    class="nav-crypto nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0 cursor_onclick">
                                    <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center"
                                        ...
                                        <span
                                            class="nav-text font-size-lg py-2 font-weight-bold text-center">数字货币</span>
                                    </a>
                                </li>
                                {/if}
                                {/if}
    ...
    <div class="modal fade" id="metronpay-modal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title {$style[$theme_style]['modal']['text_title']}" id="metronpay-title">
                        <strong>支付确认</strong>
                    </h5>
                </div>
                        ...
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0 cursor_onclick">
                            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center {if $traffic_shop@index eq 1}active{/if}"
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bold text-center">¥
                                    {$traffic_shop->price}</span>
                                <span
                                    class="nav-text font-size-lg py-2 font-weight-bold text-center">{$traffic_shop->name}</span>
                            </a>
                        </li>
                        {/if}
                        {/foreach}
